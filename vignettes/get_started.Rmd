...
airGRdatassim_bib <- gsub("@Article\\{", "@Article{piazzi_sequential_2020", airGRdatassim_bib)
...
Among the model states, the update of the routing store level ensures the most benefit from the assimilation of observed discharges. Conversely, the update of the unit hydrograph only has a slight impact on the accuracy of the DA-based discharge simulations (@piazzi_sequential_2020).
